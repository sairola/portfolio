...
<div className="max-w-sm bg-white border border-zinc-300 rounded-lg shadow ">
    ...
    <div className="p-5">
        ...
        <a href="https://github.com/sairola/arkanoid_chapuza" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-primario bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            Repositorio en GIT
...
<div className="max-w-sm bg-white border  border-zinc-300 rounded-lg shadow">
    ...
    <div className="p-5">
        ...
        <a href="https://github.com/sairola/firebaseShopping" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-primario bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        Repositorio en GIT
            <svg aria-hidden="true" className="w-4 h-4 ml-2 -mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
        </a>
    </div>
...
<div className="max-w-sm bg-white border  border-zinc-300 rounded-lg shadow">
    ...
    <div className="p-5">
        ...
        <p className="mb-3 font-normal text-gray-700 dark:text-gray-400 dark:text-blanco">Wordpress responsive. Sobre plantilla, modificación del HTML, de la hoja de estilos y gestión de eventos y funcions con JS. Formularios de contactos, y recepción de curriculums vía mail. </p>
        <a href="https://desarrollarterh.com.ar/" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-primario bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        Página web
        <svg aria-hidden="true" className="w-4 h-4 ml-2 -mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
        </a>
    </div>
